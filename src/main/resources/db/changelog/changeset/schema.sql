...
(
    ...
    stealth_disadvantage TEXT    not null,
...
(
    id               BIGINT  NOT NULL,
    number_of_dice   INTEGER not null,
    quality_of_dice  INTEGER not null,
    base_modificator INTEGER not null,
    is_universal     BOOLEAN not null,
    is_finesse       BOOLEAN not null,
    item_id          BIGINT  not null references items (id),
    CONSTRAINT pk_weapons PRIMARY KEY (id)
);

--changeset characters_items:16
